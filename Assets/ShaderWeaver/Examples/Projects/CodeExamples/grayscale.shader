		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				uv_dummy2 = float2(uv_dummy2.x >0 ?fmod(uv_dummy2.x,1+0) : (1+0) - fmod(abs(uv_dummy2.x),1+0), uv_dummy2.y >0 ?fmod(uv_dummy2.y,1+0): (1+0) - fmod(abs(uv_dummy2.y),1+0));
